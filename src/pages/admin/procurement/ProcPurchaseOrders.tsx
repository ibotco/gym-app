...
import {
  nextProcPoNumber, poTotals, isEditable, canReceive, statusLabel,
...
type LineDraft = { itemId: string; qty: string; unitCost: string; discount: string; tax: string }
            ...
            <div>
              ...
              <div className="table-wrap">
                <table className="data">
                  <thead>
                    <tr><th>Item</th><th className="w-24">Qty</th><th className="w-32">Unit cost</th><th className="w-24">Disc %</th><th className="w-24">Tax %</th><th className="w-32 text-right">Total</th><th /></tr>
                  </thead>
                  <tbody>
