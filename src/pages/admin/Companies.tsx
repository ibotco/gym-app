...
export function Companies() {
  ...
  // Creating companies is a platform operation — Super Admin / Gym Manager only.
  const isPlatformAdmin = user?.role === 'super_admin' || user?.role === 'gym_manager'
  ...
  const save = () => {
    ...
    if (isNew && !canCreate) { toast.error('Only Super Admin or Gym Manager can create another company.'); return }
