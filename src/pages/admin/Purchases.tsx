...
export function Purchases() {
  const app = useApp()
  const { inventory, suppliers, purchases, recordPurchase, updatePurchaseStatus, deletePurchase, log } = app
  ...
  const submitPurchase = () => {
    const r = recordPurchase({ supplierId: poSupplier, lines: poLines, status: poStatus, notes: poNotes, userId: user?.id || 'system', date: poDate || undefined })
