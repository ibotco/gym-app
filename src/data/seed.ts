import type {
  User, Member, Trainer, StaffRecord, Plan, Membership, Payment, Invoice, InvoiceTemplate,
  ...
  Testimonial, CompanySettings, NumberPrefix, CronSettings, PrintHeaderSettings, FrontendCmsSettings, CostCenter,
} from '../types'

export const DEFAULT_PREFIXES: NumberPrefix[] = [
  { key: 'invoice', label: 'Invoice', prefix: 'INV-' },
  { key: 'estimate', label: 'Estimate', prefix: 'EST-' },
  { key: 'proposal', label: 'Proposal', prefix: 'PRO-' },
  { key: 'salesOrder', label: 'Sales Order', prefix: 'SO-' },
  { key: 'purchaseOrder', label: 'Purchase Order', prefix: 'PO-' },
  { key: 'payment', label: 'Payment', prefix: 'PAY-' },
  { key: 'receipt', label: 'Receipt', prefix: 'RCT-' },
  { key: 'creditNote', label: 'Credit Note', prefix: 'CN-' },
  { key: 'asset', label: 'Asset Tag', prefix: 'AST-' },
]

export const DEFAULT_ALLOWED_FILE_TYPES = ['.jpg', '.jpeg', '.png', '.gif', '.pdf', '.doc', '.docx', '.xls', '.xlsx', '.csv']

export const DEFAULT_CRON_SETTINGS: CronSettings = {
  enabled: true,
  intervalMinutes: 5,
  activityLogRetentionMonths: 12,
  notificationRetentionMonths: 3,
  autoRenew: true,
...
export const DEFAULT_PRINT_HEADER: PrintHeaderSettings = {
  headerType: 'text',
  companyName: '',
  companyAddress: '',
  companyPhone: '',
  companyEmail: '',
  companyWebsite: '',
  footerContent: '<p>This document is computer generated and does not require a signature.</p>',
}

export const DEFAULT_FRONTEND_CMS: FrontendCmsSettings = {
  heroHeadline: 'Train like a pro',
  heroHighlight: 'Live like one',
  heroSubheadline: 'Strength floors, recovery suites, and an operating system that treats membership as a relationship — not a swipe.',
  heroCtaText: 'View Membership Plans',
  aboutTitle: 'Your fitness home in Accra',
  aboutBody: 'FitPro is a network of modern gyms built around community, coaching and results — with flexible memberships and everything you need to train your best.',
  socialInstagram: 'https://instagram.com/fitpro',
  socialTwitter: 'https://x.com/fitpro',
  seoTitle: 'FitPro — Premium Gyms in Accra',
  seoDescription: 'Join FitPro, Accra\u2019s premium gym network. World-class coaching, group classes and flexible memberships.',
}
...
export const COMPANY: CompanySettings = {
  ...
  frontendCms: DEFAULT_FRONTEND_CMS,
}

export const BRANCHES: Branch[] = [
  { id: 'br_airport', companyId: 'co_fitpro', name: 'Airport City Flagship', address: 'One Airport Square, Airport City', city: 'Accra', phone: '+233 30 396 4401', managerId: 'u_manager', members: 842, capacity: 1200, hours: '05:00 – 23:00', lat: 5.605, lng: -0.175 },
  { id: 'br_osu', companyId: 'co_fitpro', name: 'Osu Oxford', address: 'Oxford Street, Osu', city: 'Accra', phone: '+233 30 277 1102', managerId: 'u_manager', members: 614, capacity: 800, hours: '05:30 – 22:30', lat: 5.556, lng: -0.183 },
  { id: 'br_legon', companyId: 'co_fitpro', name: 'East Legon', address: 'American House, East Legon', city: 'Accra', phone: '+233 30 254 8803', managerId: 'u_manager', members: 531, capacity: 700, hours: '06:00 – 22:00', lat: 5.636, lng: -0.151 },
  { id: 'br_tema', companyId: 'co_fitpro', name: 'Tema Community 4', address: 'Community 4 Commercial, Tema', city: 'Tema', phone: '+233 30 320 9904', managerId: 'u_manager', members: 388, capacity: 550, hours: '05:30 – 22:00', lat: 5.669, lng: 0.017 },
  { id: 'br_airport_x', companyId: 'co_fitpro', parentId: 'br_airport', name: 'Airport City — Annex', address: 'One Airport Square, Ground Floor', city: 'Accra', phone: '+233 30 396 4412', managerId: 'u_manager', members: 120, capacity: 200, hours: '06:00 – 21:00', lat: 5.606, lng: -0.174 },
  { id: 'br_osu_b', companyId: 'co_fitpro', parentId: 'br_osu', name: 'Osu Beach Studio', address: 'Oxford Street, Beach Side', city: 'Accra', phone: '+233 30 277 1188', managerId: 'u_manager', members: 95, capacity: 150, hours: '06:00 – 20:00', lat: 5.553, lng: -0.181 },
]

export const COST_CENTERS: CostCenter[] = [
  { id: 'cc_ops', companyId: 'co_fitpro', code: 'CC-OPS-01', name: 'Club Operations', branchId: 'br_airport', department: 'Operations', managerId: 'u_manager', annualBudget: 480000, description: 'Day-to-day running costs for the flagship club — utilities, consumables, and on-site support.', status: 'active', createdAt: '2026-01-05' },
  { id: 'cc_mkt', companyId: 'co_fitpro', code: 'CC-MKT-02', name: 'Marketing & Membership Growth', department: 'Marketing', managerId: 'u_staff', annualBudget: 150000, description: 'Campaigns, promotions, and member acquisition across all branches.', status: 'active', createdAt: '2026-01-05' },
  { id: 'cc_fit', companyId: 'co_fitpro', code: 'CC-FIT-03', name: 'Equipment & Facilities', branchId: 'br_legon', department: 'Facilities', managerId: 'u_staff2', annualBudget: 220000, description: 'Equipment procurement, maintenance, and facility upgrades.', status: 'active', createdAt: '2026-02-01' },
  { id: 'cc_trn', companyId: 'co_fitpro', code: 'CC-TRN-04', name: 'Trainer Development', department: 'Human Resources', managerId: 'u_manager', annualBudget: 90000, description: 'Certifications, training programs, and wellness benefits for trainers.', status: 'active', createdAt: '2026-03-10' },
  { id: 'cc_tech', companyId: 'co_fitpro', code: 'CC-TEC-05', name: 'Technology & Systems', department: 'IT', managerId: 'u_accountant', annualBudget: 120000, description: 'Software licensing, POS hardware, and IT support.', status: 'active', createdAt: '2026-03-10' },
  { id: 'cc_evt', companyId: 'co_fitpro', code: 'CC-EVT-06', name: 'Events & Community', branchId: 'br_tema', department: 'Community', managerId: 'u_trainer4', annualBudget: 60000, description: 'Community events, workshops, and local partnerships.', status: 'inactive', createdAt: '2026-04-02' },
]
...
export const USERS: User[] = [
  ...
  { id: 'u_accountant', email: 'accountant@fitpro.gym', password: 'demo123', name: 'Akosua Mensima', role: 'accountant', avatar: '/images/member-ava-4.jpg', phone: '+233 24 111 0015', branchId: 'br_airport', status: 'active', createdAt: '2023-05-02' },
  { id: 'u_companyadmin', companyId: 'co_fitpro', email: 'companyadmin@fitpro.gym', password: 'demo123', name: 'Ekow Asante', role: 'company_admin', avatar: '/images/member-ava-6.jpg', phone: '+233 24 111 0016', status: 'active', createdAt: '2024-01-15' },
  { id: 'u_branchadmin', companyId: 'co_fitpro', email: 'branchadmin@fitpro.gym', password: 'demo123', name: 'Selina Ofori', role: 'branch_admin', avatar: '/images/member-ava-1.jpg', phone: '+233 24 111 0017', branchId: 'br_osu', status: 'active', createdAt: '2024-06-03' },
  { id: 'u_reception', email: 'reception@fitpro.gym', password: 'demo123', name: 'Kwaku Donkor', role: 'receptionist', avatar: '/images/member-ava-3.jpg', phone: '+233 24 111 0018', branchId: 'br_airport', status: 'active', createdAt: '2024-09-12' },
  { id: 'u_customer', companyId: 'co_fitpro', email: 'customer@fitpro.gym', password: 'demo123', name: 'Adjoa Biney', role: 'customer', avatar: '/images/member-ava-1.jpg', phone: '+233 24 200 1001', branchId: 'br_airport', status: 'active', createdAt: '2024-03-11' },
  { id: 'u_supplier', companyId: 'co_fitpro', email: 'supplier@fitpro.gym', password: 'demo123', name: 'GhanaFit Distributors', role: 'supplier', avatar: '/images/member-ava-3.jpg', phone: '+233 24 555 8801', branchId: 'br_airport', status: 'active', createdAt: '2024-01-08' },
  ...
  { id: 'u_member', companyId: 'co_fitpro', email: 'member@fitpro.gym', password: 'demo123', name: 'Ama Boateng', role: 'member', avatar: '/images/success-1.jpg', phone: '+233 24 555 0101', branchId: 'br_airport', status: 'active', createdAt: '2024-03-11' },
  { id: 'u_m2', companyId: 'co_fitpro', email: 'kofi.asante@mail.com', password: 'demo123', name: 'Kofi Asante', role: 'member', avatar: '/images/success-2.jpg', phone: '+233 24 555 0102', branchId: 'br_airport', status: 'active', createdAt: '2024-01-20' },
  { id: 'u_m3', companyId: 'co_fitpro', email: 'efua.adjei@mail.com', password: 'demo123', name: 'Efua Adjei', role: 'member', avatar: '/images/success-3.jpg', phone: '+233 24 555 0103', branchId: 'br_osu', status: 'active', createdAt: '2024-05-02' },
  { id: 'u_m4', companyId: 'co_fitpro', email: 'nii.armah@mail.com', password: 'demo123', name: 'Nii Armah', role: 'member', avatar: '/images/member-ava-4.jpg', phone: '+233 24 555 0104', branchId: 'br_legon', status: 'active', createdAt: '2023-11-15' },
  { id: 'u_m5', companyId: 'co_fitpro', email: 'akosua.darko@mail.com', password: 'demo123', name: 'Akosua Darko', role: 'member', avatar: '/images/member-ava-5.jpg', phone: '+233 24 555 0105', branchId: 'br_tema', status: 'active', createdAt: '2025-02-08' },
  { id: 'u_m6', companyId: 'co_fitpro', email: 'joseph.owusu@mail.com', password: 'demo123', name: 'Joseph Owusu', role: 'member', avatar: '/images/member-ava-2.jpg', phone: '+233 24 555 0106', branchId: 'br_airport', status: 'inactive', createdAt: '2023-08-22' },
  { id: 'u_m7', companyId: 'co_fitpro', email: 'adwoa.mensah@mail.com', password: 'demo123', name: 'Adwoa Mensah', role: 'member', avatar: '/images/member-ava-3.jpg', phone: '+233 24 555 0107', branchId: 'br_osu', status: 'active', createdAt: '2025-06-19' },
  { id: 'u_m8', companyId: 'co_fitpro', email: 'samuel.tetteh@mail.com', password: 'demo123', name: 'Samuel Tetteh', role: 'member', avatar: '/images/member-ava-6.jpg', phone: '+233 24 555 0108', branchId: 'br_legon', status: 'suspended', createdAt: '2024-09-01' },
  { id: 'u_m9', companyId: 'co_fitpro', email: 'maame.serwaa@mail.com', password: 'demo123', name: 'Maame Serwaa', role: 'member', avatar: '/images/member-ava-1.jpg', phone: '+233 24 555 0109', branchId: 'br_airport', status: 'active', createdAt: '2025-11-03' },
  { id: 'u_m10', companyId: 'co_fitpro', email: 'daniel.kumi@mail.com', password: 'demo123', name: 'Daniel Kumi', role: 'member', avatar: '/images/member-ava-4.jpg', phone: '+233 24 555 0110', branchId: 'br_tema', status: 'active', createdAt: '2024-07-14' },
]
...
export const MEMBERS: Member[] = [
  { id: 'mb_1', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_member', membershipId: 'ms_1', planId: 'pl_quarter', joinDate: '2024-03-11', emergency: { name: 'Kwabena Boateng', phone: '+233 24 900 1111', relation: 'Spouse' }, medicalNotes: 'Mild asthma — keep inhaler on person.', tags: ['VIP prospect', 'AM regular'], goals: ['Fat loss', '5K run'], heightCm: 168, weightKg: 64.2, dob: '1994-06-18', gender: 'female', address: 'Cantonments, Accra', qrCode: 'FITPRO-MB1-AMA', trainerId: 'tr_1' },
  { id: 'mb_2', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_m2', membershipId: 'ms_2', planId: 'pl_vip', joinDate: '2024-01-20', emergency: { name: 'Aba Asante', phone: '+233 24 900 2222', relation: 'Sister' }, medicalNotes: 'Previous ACL reconstruction (2021).', tags: ['Black Card', 'Strength'], goals: ['Hypertrophy', 'Deadlift 200kg'], heightCm: 182, weightKg: 86.4, dob: '1986-02-03', gender: 'male', address: 'Airport Residential', qrCode: 'FITPRO-MB2-KOFI', trainerId: 'tr_3' },
  { id: 'mb_3', companyId: 'co_fitpro', branchId: 'br_osu', userId: 'u_m3', membershipId: 'ms_3', planId: 'pl_annual', joinDate: '2024-05-02', emergency: { name: 'Kweku Adjei', phone: '+233 24 900 3333', relation: 'Brother' }, medicalNotes: '', tags: ['Yoga', 'Wellness'], goals: ['Mobility', 'Stress'], heightCm: 162, weightKg: 58.1, dob: '1998-11-21', gender: 'female', address: 'Labone', qrCode: 'FITPRO-MB3-EFUA', trainerId: 'tr_4' },
  { id: 'mb_4', companyId: 'co_fitpro', branchId: 'br_legon', userId: 'u_m4', membershipId: 'ms_4', planId: 'pl_month', joinDate: '2023-11-15', emergency: { name: 'Akwele Armah', phone: '+233 24 900 4444', relation: 'Mother' }, medicalNotes: 'Hypertension — monitored.', tags: ['Renewal due'], goals: ['Weight loss'], heightCm: 175, weightKg: 92.0, dob: '1979-09-09', gender: 'male', address: 'East Legon Hills', qrCode: 'FITPRO-MB4-NII', trainerId: 'tr_1' },
  { id: 'mb_5', companyId: 'co_fitpro', branchId: 'br_tema', userId: 'u_m5', membershipId: 'ms_5', planId: 'pl_quarter', joinDate: '2025-02-08', emergency: { name: 'Yaw Darko', phone: '+233 24 900 5555', relation: 'Father' }, medicalNotes: '', tags: ['New', 'Corporate'], goals: ['Tone', 'Consistency'], heightCm: 170, weightKg: 71.5, dob: '1996-04-12', gender: 'female', address: 'Tema Comm. 25', qrCode: 'FITPRO-MB5-AKOSUA', trainerId: 'tr_2' },
  { id: 'mb_6', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_m6', membershipId: 'ms_6', planId: 'pl_month', joinDate: '2023-08-22', emergency: { name: 'Esi Owusu', phone: '+233 24 900 6666', relation: 'Wife' }, medicalNotes: '', tags: ['Churn risk'], goals: ['General fitness'], heightCm: 178, weightKg: 80.0, dob: '1990-01-30', gender: 'male', address: 'Dzorwulu', qrCode: 'FITPRO-MB6-JOE' },
  { id: 'mb_7', companyId: 'co_fitpro', branchId: 'br_osu', userId: 'u_m7', membershipId: 'ms_7', planId: 'pl_annual', joinDate: '2025-06-19', emergency: { name: 'Kojo Mensah', phone: '+233 24 900 7777', relation: 'Spouse' }, medicalNotes: 'Pregnancy — cleared for prenatal yoga.', tags: ['Prenatal'], goals: ['Strength', 'Birth prep'], heightCm: 165, weightKg: 68.8, dob: '1992-08-08', gender: 'female', address: 'Osu RE', qrCode: 'FITPRO-MB7-ADWOA', trainerId: 'tr_4' },
  { id: 'mb_8', companyId: 'co_fitpro', branchId: 'br_legon', userId: 'u_m8', membershipId: 'ms_8', planId: 'pl_month', joinDate: '2024-09-01', emergency: { name: 'Ama Tetteh', phone: '+233 24 900 8888', relation: 'Sister' }, medicalNotes: '', tags: ['Payment overdue'], goals: ['Boxing'], heightCm: 180, weightKg: 77.2, dob: '1995-12-02', gender: 'male', address: 'Madina', qrCode: 'FITPRO-MB8-SAM' },
  { id: 'mb_9', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_m9', membershipId: 'ms_9', planId: 'pl_vip', joinDate: '2025-11-03', emergency: { name: 'Kwame Serwaa', phone: '+233 24 900 9999', relation: 'Father' }, medicalNotes: '', tags: ['Black Card', 'Influencer'], goals: ['Hypertrophy', 'Content'], heightCm: 171, weightKg: 62.4, dob: '1999-03-27', gender: 'female', address: 'Trasacco Valley', qrCode: 'FITPRO-MB9-MAAME', trainerId: 'tr_2' },
  { id: 'mb_10', companyId: 'co_fitpro', branchId: 'br_tema', userId: 'u_m10', membershipId: 'ms_10', planId: 'pl_quarter', joinDate: '2024-07-14', emergency: { name: 'Abena Kumi', phone: '+233 24 900 1010', relation: 'Wife' }, medicalNotes: 'Type 2 diabetes — light monitoring.', tags: ['Corporate wellness'], goals: ['Metabolic health'], heightCm: 176, weightKg: 88.6, dob: '1984-07-19', gender: 'male', address: 'Tema Comm. 10', qrCode: 'FITPRO-MB10-DAN', trainerId: 'tr_1' },
]

export const MEMBERSHIPS: Membership[] = [
  { id: 'ms_1', companyId: 'co_fitpro', memberId: 'mb_1', planId: 'pl_quarter', startDate: '2026-06-11', endDate: '2026-09-09', status: 'active', autoRenew: true, branchId: 'br_airport' },
  { id: 'ms_2', companyId: 'co_fitpro', memberId: 'mb_2', planId: 'pl_vip', startDate: '2026-01-20', endDate: '2027-01-20', status: 'active', autoRenew: true, branchId: 'br_airport' },
  { id: 'ms_3', companyId: 'co_fitpro', memberId: 'mb_3', planId: 'pl_annual', startDate: '2026-05-02', endDate: '2027-05-02', status: 'active', autoRenew: false, branchId: 'br_osu' },
  { id: 'ms_4', companyId: 'co_fitpro', memberId: 'mb_4', planId: 'pl_month', startDate: '2026-07-15', endDate: '2026-08-14', status: 'active', autoRenew: true, branchId: 'br_legon' },
  { id: 'ms_5', companyId: 'co_fitpro', memberId: 'mb_5', planId: 'pl_quarter', startDate: '2026-05-08', endDate: '2026-08-06', status: 'expired', autoRenew: false, branchId: 'br_tema' },
  { id: 'ms_6', companyId: 'co_fitpro', memberId: 'mb_6', planId: 'pl_month', startDate: '2026-04-01', endDate: '2026-05-01', status: 'cancelled', autoRenew: false, branchId: 'br_airport' },
  { id: 'ms_7', companyId: 'co_fitpro', memberId: 'mb_7', planId: 'pl_annual', startDate: '2025-06-19', endDate: '2026-06-19', status: 'expired', autoRenew: true, branchId: 'br_osu' },
  { id: 'ms_8', companyId: 'co_fitpro', memberId: 'mb_8', planId: 'pl_month', startDate: '2026-07-01', endDate: '2026-08-01', status: 'frozen', autoRenew: false, branchId: 'br_legon' },
  { id: 'ms_9', companyId: 'co_fitpro', memberId: 'mb_9', planId: 'pl_vip', startDate: '2025-11-03', endDate: '2026-11-03', status: 'active', autoRenew: true, branchId: 'br_airport' },
  { id: 'ms_10', companyId: 'co_fitpro', memberId: 'mb_10', planId: 'pl_quarter', startDate: '2026-07-14', endDate: '2026-10-12', status: 'active', autoRenew: true, branchId: 'br_tema' },
]

export const TRAINERS: Trainer[] = [
  { id: 'tr_1', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_trainer', specialties: ['Strength', 'Fat loss', 'Athletic performance'], certifications: ['NASM-CPT', 'CSCS', 'First Aid'], experienceYears: 9, bio: 'Former national-level sprinter. Builds resilient, powerful athletes with a no-drama programming style.', hourlyRate: 180, rating: 4.9, clientsCount: 34, photo: '/images/trainer-1.jpg' },
  { id: 'tr_2', companyId: 'co_fitpro', branchId: 'br_osu', userId: 'u_trainer2', specialties: ['HIIT', 'Group fitness', 'Women’s coaching'], certifications: ['ACE-CPT', 'Les Mills', 'Pre/Postnatal'], experienceYears: 7, bio: 'High-energy coach who makes hard work feel like a celebration. Specialises in sustainable fat-loss phases.', hourlyRate: 160, rating: 4.8, clientsCount: 41, photo: '/images/trainer-2.jpg' },
  { id: 'tr_3', companyId: 'co_fitpro', branchId: 'br_legon', userId: 'u_trainer3', specialties: ['Powerlifting', 'Olympic lifting', 'Rehab'], certifications: ['USAW L2', 'FMS', 'Precision Nutrition L1'], experienceYears: 12, bio: 'Quiet intensity. Twenty years under the bar. If you want a bigger squat, you want Erik.', hourlyRate: 220, rating: 5.0, clientsCount: 18, photo: '/images/trainer-3.jpg' },
  { id: 'tr_4', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_trainer4', specialties: ['Yoga', 'Mobility', 'Breathwork'], certifications: ['RYT-500', 'FRC', 'Wim Hof L1'], experienceYears: 10, bio: 'Brings nervous-system literacy to high performers. Recovery is a skill — she teaches it.', hourlyRate: 150, rating: 4.9, clientsCount: 27, photo: '/images/trainer-4.jpg' },
]

export const STAFF: StaffRecord[] = [
  { id: 'st_1', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_staff', department: 'Front of House', salary: 4200, hireDate: '2023-07-18', leaveBalance: 12, title: 'Membership Concierge' },
  { id: 'st_2', companyId: 'co_fitpro', branchId: 'br_osu', userId: 'u_staff2', department: 'Front of House', salary: 3800, hireDate: '2024-01-09', leaveBalance: 8, title: 'Reception Lead' },
  { id: 'st_3', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_manager', department: 'Operations', salary: 9800, hireDate: '2023-02-14', leaveBalance: 16, title: 'General Manager' },
  { id: 'st_4', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_trainer', department: 'Coaching', salary: 7200, hireDate: '2023-03-01', leaveBalance: 10, title: 'Head Strength Coach' },
  { id: 'st_5', companyId: 'co_fitpro', branchId: 'br_osu', userId: 'u_trainer2', department: 'Coaching', salary: 6400, hireDate: '2023-04-12', leaveBalance: 12, title: 'Group Fitness Coach' },
  { id: 'st_6', companyId: 'co_fitpro', branchId: 'br_legon', userId: 'u_trainer3', department: 'Coaching', salary: 7800, hireDate: '2023-05-20', leaveBalance: 11, title: 'Strength Coach' },
  { id: 'st_7', companyId: 'co_fitpro', branchId: 'br_airport', userId: 'u_trainer4', department: 'Coaching', salary: 6000, hireDate: '2023-06-02', leaveBalance: 14, title: 'Recovery & Mobility Coach' },
]
...
export const INVOICES: Invoice[] = [
  ...
  {
    id: 'inv_12', companyId: 'co_fitpro', memberId: 'mb_9', number: 'FP-2026-2255', items: [{ desc: 'Studio Monthly', amount: 280 }], total: 280, status: 'paid', issuedAt: '2026-05-04', dueAt: '2026-05-08',
    recurrence: { frequency: 'monthly', every: 1, issued: 4, nextAt: '2026-08-04' },
  },
]

/** Reusable invoice skeletons — selectable in the Add/Edit invoice editor. */
export const INVOICE_TEMPLATES: InvoiceTemplate[] = [
  {
    id: 'itpl_1', name: 'Gym membership — monthly',
    items: [{ desc: 'Gym membership — monthly', amount: 350 }],
    dueInDays: 7,
    notes: 'Amount covers one membership cycle. Auto-renewal applies unless cancelled 7 days before the cycle ends.',
    createdAt: '2026-01-02T09:00:00',
  },
  {
    id: 'itpl_2', name: 'Personal training — 1 session',
    items: [{ desc: 'Personal training — 60 min', amount: 180 }],
    dueInDays: 0,
    createdAt: '2026-01-02T09:05:00',
  },
  {
    id: 'itpl_3', name: 'Class pack — 10 sessions',
    items: [{ desc: 'Class pack — 10 sessions', qty: 1, unitPrice: 900, amount: 900 }],
...
export const DEMO_ACCOUNTS = [
  ...
  { role: 'Branch Admin', email: 'branchadmin@fitpro.gym', password: 'demo123', hint: 'Osu Oxford branch' },
  { role: 'Company Admin', email: 'companyadmin@fitpro.gym', password: 'demo123', hint: 'Company & branch control' },
  { role: 'Accountant', email: 'accountant@fitpro.gym', password: 'demo123', hint: 'Finance — suppliers & customers' },
  { role: 'Customer', email: 'customer@fitpro.gym', password: 'demo123', hint: 'Adjoa Biney — customer portal' },
  { role: 'Supplier', email: 'supplier@fitpro.gym', password: 'demo123', hint: 'GhanaFit — supplier portal' },
