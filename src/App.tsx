...
const CostCenters = lazy(() => import('./pages/admin/CostCenters').then((m) => ({ default: m.CostCenters })))
...
const EmailTemplatesAdmin = lazy(() => import('./pages/admin/MessageTemplates').then((m) => ({ default: m.EmailTemplates })))
const SmsTemplatesAdmin = lazy(() => import('./pages/admin/MessageTemplates').then((m) => ({ default: m.SmsTemplates })))
      ...
      <S>
        <Routes>
          ...
          >
            ...
            <Route path="cost-centers" element={<Protected roles={mgr}><CostCenters /></Protected>} />
            ...
            <Route path="email-templates" element={<Protected roles={mgr}><EmailTemplatesAdmin /></Protected>} />
            <Route path="sms-templates" element={<Protected roles={mgr}><SmsTemplatesAdmin /></Protected>} />
