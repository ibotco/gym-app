...
export const INVENTORY: InventoryItem[] = [
  { id: 'inv_1', name: 'Whey Protein (2.27kg)', brand: 'FitPro Labs', sku: 'SUP-WHEY-2.2', category: 'Supplements', quantity: 14, reorderPoint: 8, unit: 'pcs', costPrice: 520, sellPrice: 780, supplierId: 'sup_1', branchId: 'br_airport', createdAt: '2026-05-10', updatedAt: '2026-08-10' },
  { id: 'inv_2', name: 'Creatine Monohydrate (300g)', brand: 'FitPro Labs', sku: 'SUP-CRE-300', category: 'Supplements', quantity: 6, reorderPoint: 10, unit: 'pcs', costPrice: 180, sellPrice: 260, supplierId: 'sup_1', branchId: 'br_airport', createdAt: '2026-05-10', updatedAt: '2026-08-12' },
  { id: 'inv_3', name: 'Pre-Workout (30 servings)', brand: 'Kinetic Fuel', sku: 'SUP-PRE-30', category: 'Supplements', quantity: 22, reorderPoint: 12, unit: 'pcs', costPrice: 240, sellPrice: 340, supplierId: 'sup_1', branchId: 'br_airport', createdAt: '2026-06-02', updatedAt: '2026-08-01' },
  { id: 'inv_4', name: 'Electrolyte Drink 500ml', brand: 'PureWave', sku: 'BEV-ELY-500', category: 'Beverages', quantity: 48, reorderPoint: 30, unit: 'bottle', costPrice: 6, sellPrice: 12, supplierId: 'sup_3', branchId: 'br_airport', createdAt: '2026-04-18', updatedAt: '2026-08-13' },
  { id: 'inv_5', name: 'Still Water 750ml', brand: 'PureWave', sku: 'BEV-WTR-750', category: 'Beverages', quantity: 12, reorderPoint: 40, unit: 'bottle', costPrice: 2, sellPrice: 5, supplierId: 'sup_3', branchId: 'br_osu', createdAt: '2026-04-18', updatedAt: '2026-08-13' },
  { id: 'inv_6', name: 'Protein Bar (Chocolate)', brand: 'Kinetic Fuel', sku: 'SNK-BAR-CHO', category: 'Snacks', quantity: 60, reorderPoint: 30, unit: 'pcs', costPrice: 14, sellPrice: 22, supplierId: 'sup_1', branchId: 'br_osu', createdAt: '2026-03-09', updatedAt: '2026-08-11' },
  { id: 'inv_7', name: 'FitPro Training Tee (L)', brand: 'FitPro Apparel', sku: 'APP-TEE-L', category: 'Apparel', quantity: 18, reorderPoint: 10, unit: 'pcs', costPrice: 60, sellPrice: 120, supplierId: 'sup_2', branchId: 'br_airport', createdAt: '2026-02-20', updatedAt: '2026-07-28' },
  { id: 'inv_8', name: 'Microfibre Gym Towel', brand: 'FitPro Apparel', sku: 'APP-TWL', category: 'Apparel', quantity: 4, reorderPoint: 12, unit: 'pcs', costPrice: 35, sellPrice: 65, supplierId: 'sup_2', branchId: 'br_airport', createdAt: '2026-02-20', updatedAt: '2026-08-12' },
  { id: 'inv_9', name: 'Resistance Band Set', brand: 'Accra Sports', sku: 'EQP-BAND-SET', category: 'Equipment', quantity: 0, reorderPoint: 6, unit: 'set', costPrice: 90, sellPrice: 160, supplierId: 'sup_2', branchId: 'br_airport', createdAt: '2026-01-15', updatedAt: '2026-08-09' },
  { id: 'inv_10', name: 'Lifting Gloves (Pair)', brand: 'Accra Sports', sku: 'EQP-GLV-PR', category: 'Equipment', quantity: 9, reorderPoint: 8, unit: 'pcs', costPrice: 55, sellPrice: 95, supplierId: 'sup_2', branchId: 'br_osu', createdAt: '2026-01-15', updatedAt: '2026-07-30' },
  { id: 'inv_11', name: 'Foam Roller (60cm)', brand: 'Recovery Lab', sku: 'REC-FR-60', category: 'Recovery', quantity: 11, reorderPoint: 6, unit: 'pcs', costPrice: 110, sellPrice: 180, supplierId: 'sup_4', branchId: 'br_airport', createdAt: '2026-03-25', updatedAt: '2026-08-05' },
  { id: 'inv_12', name: 'Massage Ball', brand: 'Recovery Lab', sku: 'REC-MB', category: 'Recovery', quantity: 25, reorderPoint: 10, unit: 'pcs', costPrice: 25, sellPrice: 45, supplierId: 'sup_4', branchId: 'br_airport', createdAt: '2026-03-25', updatedAt: '2026-08-08' },
]
