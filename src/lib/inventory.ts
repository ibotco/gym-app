import type { InventoryCategory, InventoryItem, StockTransaction, Supplier, Purchase, Sale, PurchaseOrder, PurchaseOrderStatus, PurchaseReturn, PurchaseReturnStatus } from '../types'
...
export const SUPPLIERS: Supplier[] = [
  { id: 'sup_1', name: 'GhanaFit Distributors', contact: 'Kwame Owusu', email: 'orders@ghanafit.gh', phone: '+233 24 555 8801', category: 'Supplements', userId: 'u_supplier' },
  { id: 'sup_2', name: 'Accra Sports Supply', contact: 'Ama Mensah', email: 'sales@accrasports.gh', phone: '+233 24 555 8802', category: 'Equipment' },
  { id: 'sup_3', name: 'PureWave Beverages', contact: 'Yaw Darko', email: 'hello@purewave.gh', phone: '+233 24 555 8803', category: 'Beverages' },
  { id: 'sup_4', name: 'Recovery Lab GH', contact: 'Esi Quartey', email: 'support@recoverylab.gh', phone: '+233 24 555 8804', category: 'Recovery' },
]
...
export const INVENTORY: InventoryItem[] = [
  ...
  { id: 'inv_5', name: 'Still Water 750ml', sku: 'BEV-WTR-750', category: 'Beverages', quantity: 12, reorderPoint: 40, unit: 'bottle', costPrice: 2, sellPrice: 5, supplierId: 'sup_3', branchId: 'br_airport', createdAt: '2026-04-18', updatedAt: '2026-08-13' },
  { id: 'inv_6', name: 'Protein Bar (Chocolate)', sku: 'SNK-BAR-CHO', category: 'Snacks', quantity: 60, reorderPoint: 30, unit: 'pcs', costPrice: 14, sellPrice: 22, supplierId: 'sup_1', branchId: 'br_airport', createdAt: '2026-03-09', updatedAt: '2026-08-11' },
  ...
  { id: 'inv_10', name: 'Lifting Gloves (Pair)', sku: 'EQP-GLV-PR', category: 'Equipment', quantity: 9, reorderPoint: 8, unit: 'pcs', costPrice: 55, sellPrice: 95, supplierId: 'sup_2', branchId: 'br_airport', createdAt: '2026-01-15', updatedAt: '2026-07-30' },
...
export const PURCHASES: Purchase[] = [
  {
    id: 'po_1', number: 'PO-2026-001', supplierId: 'sup_1', status: 'received',
    lines: [
  ...
  {
    id: 'po_2', number: 'PO-2026-002', supplierId: 'sup_3', status: 'received',
  ...
  {
    id: 'po_3', number: 'PO-2026-003', supplierId: 'sup_4', status: 'ordered',
...
export const PURCHASE_RETURNS: PurchaseReturn[] = [
  {
    id: 'pr_1', number: 'PR-2026-001', supplierId: 'sup_1', status: 'returned',
