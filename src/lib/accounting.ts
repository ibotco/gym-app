...
import type {
  ...
  ChequeEntry,
  JournalVoucher, PaymentVoucher, ReceiptVoucher, SupplierPayment, SupplierInvoice, GoodsReceipt, ValueBookEntry, VoucherSerial, Fund, PaymentModeOption, AccountDetailType, IncomeStatementMod, CurrencyRate, AccountType, ReceiptLine,
} from '../types'
...
export function historyRowsForSupplierInvoice(
  ...
  if (itemNet > 0) {
    rows.push({ ...shared, id: `ah_sinv_${inv.id}_items`, account: itemAccount, debit: itemNet, credit: 0, split: payable })
  }
