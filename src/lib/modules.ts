...
export const MODULES: ModuleDef[] = [
  ...
  { id: 'organizations', label: 'Organizations', description: 'Companies and branch locations.', navKeys: ['nav.organizations'], defaultEnabled: true },
  ...
  { id: 'costCenters', label: 'Cost Centers', description: 'Organisational cost centers, budgets, and allocation.', navKeys: ['nav.costCenters'], defaultEnabled: true },
